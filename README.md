...
running command...
$ esm1 (--version)
@oclif/plugin-test-esm-1/0.8.108 linux-x64 node-v20.20.1
$ esm1 --help [COMMAND]
USAGE
  $ esm1 COMMAND
...
...
_See code: [src/commands/esm1.ts](https://github.com/oclif/plugin-test-esm-1/blob/0.8.108/src/commands/esm1.ts)_
